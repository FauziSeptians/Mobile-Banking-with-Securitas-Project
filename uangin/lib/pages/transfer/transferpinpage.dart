...
class TfPinPage extends StatefulWidget {
  
  const TfPinPage({super.key, required this.user, required this.catatan, required this.contact, required this.nominal, required this.kategori});
  ...
  @override
  State<TfPinPage> createState() => _TfPinPageState();
}

class _TfPinPageState extends State<TfPinPage> {
  ...
  void getToken() async {
    print('woi');
    String token = await AuthController.getFirebaseMessage();
      ...
      if (_pinInput.toString() ==  savedValue) {
        ...
        Future.delayed(const Duration(milliseconds: 200) , (){
          Navigator.pushReplacement(
            ...
            PageTransition (child: TfReceiptPage(user: widget.user, catatan: widget.catatan, nominal: widget.nominal, contact: widget.contact, kategori: widget.kategori,), type: PageTransitionType.fade,duration: const Duration(milliseconds: 250))
          );
        });

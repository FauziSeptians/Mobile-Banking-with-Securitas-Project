...
import 'package:uangin/pages/changepinpage2.dart';
...
class ChangePinWidget extends StatefulWidget {
  ...
  const ChangePinWidget({super.key, required this.user});
    ...
    if (_pinBoxIndex == 6) {
      if (_pinInput.toString() ==  savedValue) {
        ...
        Future.delayed(const Duration(milliseconds: 200) , (){
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ChangePin2Widget(user: widget.user)));
        });
            ...
            body: Center(
              child: Column(
                ...
                children:  [
                  ...
                  const Text('Masukkan PIN Lama', style: TextStyle(fontFamily: 'OpenSans', fontWeight: FontWeight.w700, fontSize: 25, color: Color(0xff5ADFB2),),),

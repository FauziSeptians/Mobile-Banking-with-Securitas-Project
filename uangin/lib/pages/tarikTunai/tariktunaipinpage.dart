...
import 'package:uangin/pages/tarikTunai/tariktunaireceiptpage.dart';
...
class TarikTunaiPinPage extends StatefulWidget {
  
  const TarikTunaiPinPage({super.key, required this.user, required this.nominal});
  ...
  @override
  State<TarikTunaiPinPage> createState() => _TarikTunaiPinPageState();
}

class _TarikTunaiPinPageState extends State<TarikTunaiPinPage> {
      ...
      if (_pinInput.toString() ==  savedValue) {
        ...
        Future.delayed(const Duration(milliseconds: 200) , (){
          Navigator.pushReplacement(
            ...
            PageTransition (child: TarikTunaiReceiptPage(user: widget.user, nominal: widget.nominal), type: PageTransitionType.fade,duration: const Duration(milliseconds: 250))
          );
        });

...
import 'package:uangin/pages/setortunaidetailpage.dart';
...
class SetorPinWidget extends StatefulWidget {
  
  const SetorPinWidget({super.key});

  @override
  State<SetorPinWidget> createState() => _SetorPinWidgetState();
}

class _SetorPinWidgetState extends State<SetorPinWidget> {
      ...
      if (_pinInput.toString() ==  savedValue) {
        ...
        Future.delayed(const Duration(milliseconds: 200) , (){
          Navigator.pushReplacement(
            ...
            PageTransition ( child: const SetorTunaiDetailPage(), type: PageTransitionType.fade,duration: const Duration(milliseconds: 250))
          );
        });
